...
window.emptyState = function (title, message, status, url) {
  return '' + '<div class="empty-state">' + '<div class="empty-state-icon bg-' + status + '">' + '<i class="' + (status == "danger") ? 'fas fa-times' : 0;
};
...
/******/ __webpack_require__.O(0, ["/js/dashboard/vendor"], () => (__webpack_exec__("./resources/js/dashboard/app.js")));
